...
class OpenFile(Base, BASE_TABLE): 
   "Tabla con los valores OpenFile" 
...
class CpuTime(Base, BASE_TABLE): 
   "Tabla con los valores cpu_times" 
...
for proc in psutil.process_iter(): 
   with proc.oneshot(): 
       ...
       p.create_time       =  datetime.datetime. 
